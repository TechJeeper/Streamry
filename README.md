...
| Platform | Installer |
| -------- | --------- |
| Windows 10/11 (x64) | [Streamry_0.1.1_x64-setup.exe](Website/downloads/Streamry_0.1.1_x64-setup.exe) |
| macOS (Apple silicon + Intel) | [Streamry_0.1.1_universal.dmg](Website/downloads/Streamry_0.1.1_universal.dmg) |
